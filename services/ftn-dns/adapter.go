...
func(h Health)Valid()bool{return h.LatencyMS>=0&&!math.IsNaN(h.LossRatio)&&!math.IsInf(h.LossRatio,0)&&h.LossRatio>=0&&h.LossRatio<=1}
func(r Response)Valid()bool{n:=r.Normalized();return n.Name!=""&&n.RecordType!=""&&len(n.Values)>0}
