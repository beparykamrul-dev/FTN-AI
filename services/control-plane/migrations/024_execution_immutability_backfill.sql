-- FTN worker execution immutability backfill.
-- 017_execution_immutability.sql was a duplicate migration version and therefore
-- could never be reached by the versioned migration runner after 017 had already
-- been recorded. Keep production history append-only and apply the omitted
-- integrity boundary as a new migration instead of rewriting an applied version.
