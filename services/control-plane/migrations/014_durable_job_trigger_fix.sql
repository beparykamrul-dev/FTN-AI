-- Consolidate durable job lifecycle triggers for existing databases.
-- The legacy trigger set could emit duplicate lifecycle events and one path
-- attempted to insert NULL into event_journal.causation_id (NOT NULL).
