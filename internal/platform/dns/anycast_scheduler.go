...
func(s AnycastSchedule)Validate()error{if s.Interval<=0||s.Interval>24*time.Hour{return fmt.Errorf("probe interval must be between 1ns and 24h")};if err:=s.Probe.Validate();err!=nil{return err};return s.Policy.Validate()}
