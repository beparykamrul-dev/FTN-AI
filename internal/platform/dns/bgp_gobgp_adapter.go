...
func(a *GoBGPAdapter)Validate()error{if a==nil{return fmt.Errorf("GoBGP adapter is required")};if !a.Enabled{return nil};if strings.TrimSpace(a.Address)==""{return fmt.Errorf("GoBGP address is required")};return nil}
