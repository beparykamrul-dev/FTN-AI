...
func(o NetBoxObject)Valid()bool{return strings.TrimSpace(o.ID)!=""&&strings.TrimSpace(o.Type)!=""&&strings.TrimSpace(o.Name)!=""&&len(strings.TrimSpace(o.ID))<=256&&len(strings.TrimSpace(o.Type))<=128&&len(strings.TrimSpace(o.Name))<=512&&len(o.Metadata)<=128}
