...
// BuildFiberRecoveryPlan produces deterministic recovery candidates from the
// known topology. It never changes the physical topology itself.
func (m *FiberMap) BuildFiberRecoveryPlan(failedID string) (RecoveryPlan, error) {
	...
	out := RecoveryPlan{RootAsset: failedID, FailedAssetID: failedID, RequiresApproval: true}
