...
func(a LuaAdapter)Validate()error{if strings.TrimSpace(a.Name)!="lua-gis"{return fmt.Errorf("invalid lua adapter name")};if strings.TrimSpace(a.Version)==""{return fmt.Errorf("lua version is required")};return nil}
